...
def main() -> None:
    ...
    BOT_TOKEN = "6680224136:AAH95LjUiyLSC8PuyMy10jXxx4-op2i-teI"
    WEBHOOK_URL = "https://webhook.site"
    PRIVATE_KEY_PATH = 'C:\\Users\\fikir\\OneDrive\\Desktop\\Gamebot\\private.key'
    CERTIFICATE_PATH = 'C:\\Users\\fikir\\OneDrive\\Desktop\\Gamebot\\cert.pem'

    PORT = 8443  # Replace with the port your web server will use
    ...
    updater.start_webhook(
        ...
        port=PORT,
        url_path=BOT_TOKEN,
        key=PRIVATE_KEY_PATH,  # Path to your SSL private key file
        cert=CERTIFICATE_PATH,  # Path to your SSL certificate file
