...
def get_keyboard():
    contact_button = KeyboardButton('Are you agree to share your phone Number', request_contact=True)
...
def contact_callback(update, context: CallbackContext):
    ...
    print("data:", data, api_url, headers)
    ...
    try:
        ...
        if response.status_code == 201:
            update.effective_message.reply_text(
                "You are successfully registered for this Service by the phone you Input!",
...
def handle_button_click(update: Update, context: CallbackContext):
    ...
    if payload in list_button_click:
        ...
        headers = { 'Content-Type': 'application/json', 
               ...
               'telegram_user_id': '1001774804799' }
